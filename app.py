...
def main():
    ...
    # Main content tabs
    tab_overview, tab_technicals, tab_derivatives, tab_options, tab_etf, tab_polymarket, tab_kalshi, tab_macro, tab_treasury = st.tabs(
        ["📈 Market Snapshot", "📊 Technical Analysis", "🔥 Derivatives Intel", "📉 Options Analytics", "📊 ETF Flow", "🎯 Polymarket Predictions", "📉 Kalshi Predictions", "🌍 Market Index & Macro Event", "📊 Treasury Yields"]
    )
    ...
    with tab_polymarket:
        ...
        llm_enabled = st.checkbox(
            "🤖 Use Gemini to filter related predictions",
        ...
        if llm_enabled and not has_gemini_key():
            st.info("Set `GEMINI_API_KEY` to enable LLM filtering.")
